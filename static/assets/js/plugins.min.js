...
!function(t, e) {
    ...
    function i(t, e) {
        ...
        return function() {
            ...
            s = arguments;
            var t = new Date - l;
            return r || (t >= e ? i() : r = setTimeout(i, e - t)),
            o
        }
    }
    function n() {}
    ...
    function o(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null)
          , n = s(i[e]);
        return W || "width" !== e ? W || "height" !== e || (n += s(i.paddingTop) + s(i.paddingBottom) + s(i.borderTopWidth) + s(i.borderBottomWidth)) : n += s(i.paddingLeft) + s(i.paddingRight) + s(i.borderLeftWidth) + s(i.borderRightWidth),
        n
    }
    function r(t) {
    ...
    function u(t) {
        return !!H[t] && (H[t].element.removeEventListener(q, H[t].listener),
        H[t] = null,
        !0)
    }
    function h(t, e) {
        var i = a()
          , n = function(t) {
            t.currentTarget === t.target && (u(i),
            e(t))
        };
        return t.addEventListener(q, n),
        H[i] = {
            element: t,
            listener: n
        },
      ...
      , B = function() {
        ...
        return M(t, [{
            ...
            value: function() {
                ...
                this.element.classList.add(F.VISIBLE)
            }
        }, {
            key: "hide",
            value: function() {
                this.isVisible = !1,
                this.element.classList.remove(F.VISIBLE),
                this.element.classList.add(F.HIDDEN)
            }
        }, {
            key: "init",
            value: function() {
                this.addClasses([F.SHUFFLE_ITEM, F.VISIBLE]),
            ...
            key: "dispose",
            value: function() {
                this.removeClasses([F.HIDDEN, F.VISIBLE, F.SHUFFLE_ITEM]),
    ...
    V.style.cssText = "width:10px;padding:2px;box-sizing:border-box;",
    O.appendChild(V);
    ...
    var R = {
      ...
      , Y = function() {
        function t(e) {
            ...
            D(this, t),
            this.options = w(t.options, i),
            this.useSizer = !1,
            this.lastSort = {},
            this.group = t.ALL_ITEMS,
            this.lastFilter = t.ALL_ITEMS,
            this.isEnabled = !0,
            this.isDestroyed = !1,
        ...
        return M(t, [{
            ...
            value: function() {
                ...
                this.options.sizer && (this.useSizer = !0),
            ...
            value: function(e, i) {
                var n = void 0;
                return n = "function" == typeof this.options.columnWidth ? this.options.columnWidth(e) : this.useSizer ? t.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : this.items.length > 0 ? t.getSize(this.items[0].element, !0).width : e,
                0 === n && (n = e),
                n + i
            }
        }, {
            ...
            value: function(t) {
                ...
                return !this.isDestroyed && (e.shuffle = this,
            ...
            value: function(e) {
                ...
                e.forEach(function(e) {
                    function s() {
                        e.element.style.transitionDelay = "",
                    ...
                    if (A.equals(o, a) && r === B.Scale.VISIBLE)
                        return e.applyCss(B.Css.VISIBLE.before),
                        void s();
                    e.point = a,
                    e.scale = B.Scale.VISIBLE;
                    var u = w(B.Css.VISIBLE.before);
                    u.transitionDelay = i._getStaggerAmount(n) + "ms",
                    i._queue.push({
                        item: e,
                        styles: u,
                        callback: s
            ...
            value: function() {
                ...
                e.forEach(function(e) {
                    ...
                    if (e.scale === B.Scale.HIDDEN)
                        return e.applyCss(B.Css.HIDDEN.before),
                        void n();
            ...
            value: function(t) {
                ...
                var n = e.point.x
                  , s = e.point.y;
                return this.options.useTransforms ? i.transform = "translate(" + n + "px, " + s + "px) scale(" + e.scale + ")" : (i.left = n + "px",
                i.top = s + "px"),
                i
            }
        }, {
            ...
            value: function(t) {
                var e = this;
                return function(i) {
                    t.item.applyCss(e._getStylesForTransition(t)),
            ...
            value: function(e) {
                ...
                if (e.length) {
                    ...
                    t._skipTransitions(n, function() {
                        e.forEach(function(t) {
                            t.item.applyCss(i._getStylesForTransition(t)),
                            t.callback()
                        })
                    })
                }
            ...
            key: "filter",
            value: function(e, i) {
                this.isEnabled && ((!e || e && 0 === e.length) && (e = t.ALL_ITEMS),
                this._filter(e),
                this._shrink(),
            ...
            value: function(e) {
                ...
                if (e.length) {
                    var n = T(e)
                      ...
                      , o = function e() {
                        i.element.removeEventListener(t.EventType.LAYOUT, e),
                        i._disposeItems(s),
                    ...
                    this._updateItemCount(),
                    this.element.addEventListener(t.EventType.LAYOUT, o)
                }
            }
        }, {
    ...
    return Y.ShuffleItem = B,
    Y.ALL_ITEMS = "all",
    Y.FILTER_ATTRIBUTE_KEY = "groups",
    Y.EventType = {
    ...
    Y.__sorter = l,
    Y.__getColumnSpan = d,
    Y.__getAvailablePositions = m,
    Y.__getShortColumn = v,
    Y
});
...
$.fn.easeScroll = function(e) {
    !function() {
        ...
        function a() {
            if (document.body) {
                var e = document.body
                  ...
                  , r = e.scrollHeight;
                if (b = document.compatMode.indexOf("CSS") >= 0 ? a : e,
                d = e,
                t(),
                v = !0,
                top != self)
                    ...
                    setTimeout(function() {
                        n || a.scrollHeight == document.height || (n = !0,
                        setTimeout(function() {
                ...
                m.fixedBackground || h || (e.style.backgroundAttachment = "scroll",
        ...
        function o(e, t, a, o) {
            ...
            1 != m.accelerationMax) {
                ...
                if (r < m.accelerationDelta) {
                    var n = (1 + 30 / r) / 2;
                    n > 1 && (n = Math.min(n, m.accelerationMax),
                    t *= n,
                    a *= n)
                }
                D = +new Date
                ...
                var c = e === document.body
                  , u = function() {
                    for (var r = +new Date, n = 0, i = 0, l = 0; l < k.length; l++) {
                        ...
                        m.pulseAlgorithm && (h = (v = h) >= 1 ? 1 : 0 >= v ? 0 : (1 == m.pulseNormalize && (m.pulseNormalize /= s(1)),
                        s(v)));
                    ...
                    var v;
                    c ? window.scrollBy(n, i) : (n && (e.scrollLeft += n),
                    i && (e.scrollTop += i)),
                    t || a || (k = []),
        ...
        function r(e) {
            var t = e.target
              , a = e.ctrlKey || e.altKey || e.metaKey || e.shiftKey && e.keyCode !== S.spacebar;
            if (/input|textarea|select|embed/i.test(t.nodeName) || t.isContentEditable || e.defaultPrevented || a)
                return !0;
            if (c(t, "button") && e.keyCode === S.spacebar)
                return !0;
            var r = 0
              , n = 0
              , l = i(d)
        ...
        var d, p = $.extend({
            ...
            x: 0,
            y: 0
        }, v = !1, b = document.documentElement, y = [120, 120, 120], S = {
            left: 37,
            up: 38,
            right: 39,
            down: 40,
        ...
        ), A = window.requestAnimationFrame || window.webkitRequestAnimationFrame || function(e, t, a) {
            window.setTimeout(e, a || 1e3 / 60)
        }
        , C = /chrome|iPad/i.test(window.navigator.userAgent);
        "onmousewheel"in document && C && (l("mousedown", function(e) {
            d = e.target
        }),
        l("mousewheel", function(e) {
            ...
            var t = e.target
              , r = i(t);
            if (!r || e.defaultPrevented || c(d, "embed") || c(t, "embed") && /\.pdf/i.test(t.src))
                return !0;
            var n = e.wheelDeltaX || 0
              , l = e.wheelDeltaY || 0;
            return n || l || (l = e.wheelDelta || 0),
            !(m.touchpadSupport || !function(e) {
                if (e) {
                    e = Math.abs(e),
                    y.push(e),
                    y.shift(),
            ...
            }(l)) || (Math.abs(n) > 1.2 && (n *= m.stepSize / 120),
